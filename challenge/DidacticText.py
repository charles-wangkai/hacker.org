...
# Q: http://www.hacker.org/challenge/chal.php?id=127
# A: http://www.hacker.org/challenge/chal.php?answer=today&id=127&go=Submit (The meaningful diff result is "the solution is today brave solvers")
...
'''
    ...
    pprint.pprint(list(difflib.Differ().compare(modified.split(sep='.'), original.split(sep='.'))), width=1000)
